										...
										<div class="card-sigin">
											<div class="main-signup-header">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleFormControlSelect1">{{trans('Dashboard/login_trans.entrance_way')}}</label>
                                                    <select class="form-control" id="sectionChooser">
                                                        <option value="" selected disabled>{{trans('Dashboard/login_trans.choose_from_list')}}</option>
                                                        <option value="user">{{trans('Dashboard/login_trans.as_patient')}}</option>
                                                        <option value="admin">{{trans('Dashboard/login_trans.as_admin')}}</option>
                                                        <option value="doctor">{{trans('Dashboard/login_trans.as_doctor')}}</option>
												...
												<h5 class="font-weight-semibold mb-4">{{trans('Dashboard/login_trans.login_patient')}}</h5>
                                                ...
                                                <div class="loginform" id="admin">
                                                    <h5 class="font-weight-semibold mb-4">{{trans('Dashboard/login_trans.login_admin')}}</h5>
                                                ...
                                                <div class="loginform" id="doctor">
                                                    <h5 class="font-weight-semibold mb-4">{{trans('Dashboard/login_trans.login_doctor')}}</h5>
